...
class DetalheSessao2 extends Component {
          ...
          <View>
              <View style={{flexDirection: 'row', height: 32, marginLeft: 10}}>
                <View style={{justifyContent: 'center'}}>
                  <Text style={{color: '#262626', fontSize: 14, fontStyle: 'italic'}}>{arquivo.name} - </Text>
                </View>
                {/*<View style={{justifyContent: 'center', flex: 1, marginRight: 10}}>*/}
                <View style={{justifyContent: 'center'}}>
                  <Text style={{fontSize: 14, fontStyle: 'italic', textAlign: 'right'}}>{arquivo.partido}</Text>
                </View>
              </View>
          </View>
    );
  ...
  _renderItemMaterias(arquivo) {
    return (
        <View style={{marginLeft: 10, marginVertical: 6, marginRight: 8}}>
            <Text style={{color: '#262626', fontSize: 14}}>{arquivo.titulo}: {arquivo.descricao}</Text>
            <Text style={{fontSize: 14, fontStyle: 'italic'}}>Autor: {arquivo.autor}</Text>
        </View>
    );
  }
        ...
        <View style={styles.container}>
            ...
            <View style={styles.mesaDiretora}>
                <View style={{backgroundColor: '#f2f2f2', borderWidth: 0.5, height: 50, justifyContent: 'center', borderLeftWidth: 0, borderRightWidth: 0}}>
                    <Text style={{fontWeight: 'bold', textAlign: 'center', fontSize: 16, color: 'black', marginLeft: 10}}>Mesa Diretora </Text>
                </View>
                <ListView
          ...
          <View style={styles.mesaDiretora}>
                <View style={{backgroundColor: '#f2f2f2', borderWidth: 0.5, height: 50, justifyContent: 'center', borderLeftWidth: 0, borderRightWidth: 0}}>
                    <Text style={{fontWeight: 'bold', textAlign: 'center', fontSize: 16, color: 'black', marginLeft: 10}}>Presentes </Text>
                </View>
                <ListView
              ...
              <View style={{backgroundColor: '#e6e6e6', borderWidth: 0.5, borderColor: 'transparent', borderBottomColor: '#262626'}}>
                  <View style={{flexDirection: 'row', height: 36, marginLeft: 10, marginRight: 16, justifyContent: 'flex-end'}}>
                        <View style={{justifyContent: 'center'}}>
                              <Text style={{color: '#262626', fontSize: 14}}> Total de presentes: </Text>
                        </View>
                        <View style={{justifyContent: 'center'}}>
                              <Text style={{fontSize: 14, textAlign: 'right'}}>{this.state.totalPresentes}</Text>
                        </View>
                  </View>
              </View>
          </View>
            ...
            <View style={styles.mesaDiretora}>
                <View style={{backgroundColor: '#f2f2f2', borderWidth: 0.5, height: 50, justifyContent: 'center', borderLeftWidth: 0, borderRightWidth: 0}}>
                    <Text style={{fontWeight: 'bold', textAlign: 'center', fontSize: 16, color: 'black', marginLeft: 10}}>Matérias </Text>
                </View>
                <ListView
            ...
            <View style={styles.mesaDiretora}>
                <View style={{backgroundColor: '#f2f2f2', borderWidth: 0.5, height: 50, justifyContent: 'center', borderLeftWidth: 0, borderRightWidth: 0}}>
                    <Text style={{fontWeight: 'bold', textAlign: 'center', fontSize: 16, color: 'black', marginLeft: 10}}>Downloads </Text>
                </View>
                <ListView
