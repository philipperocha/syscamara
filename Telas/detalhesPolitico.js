...
import { StyleSheet, StatusBar, Image, View, Text, ScrollView, Dimensions, Linking, Platform } from 'react-native';
import { Tile, List, ListItem } from 'react-native-elements';
import LikeButton from '../src/components/auxiliares/LikeButton';
...
const img = require('../src/img/back.png');
    ...
    return (
      <View style={{flex: 1}}>
        ...
        <ScrollView style={styles.container}>
            ...
            <Image style={styles.backProfile} source={img}>
